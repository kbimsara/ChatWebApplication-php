...
<body>
    ...
    <div class="container col-12 col-sm-12 col-md-11 col-lg-10 col-xl-9 clr">
        ...
        <div class="row">
            ...
            <!-- Right side -->
            <div class="col-10 d-flex align-items-end justify-content-center" style="min-height: 550px;">
                <center>
                    ...
                    <div class="msg-send-box col-12 d-flex justify-content-end align-items-end justify-content-end text-end flex-row">
                        <input type="text" class="form-control" id="data" name="data" placeholder="Type a massage">
...
<script>
    ...
    function refresh() {
        ...
        xhttp.open("GET", "server/msg.php?group_id=" + id, true);
        xhttp.send();
    }
    setInterval(function() {
        refresh();
    ...
    function select(group_id, group_name) {
        // alert(group_name);
        document.getElementById("user-name-r-side").innerHTML = group_name;
        refresh();
